...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(animals){
    const displayNames = []
    animals.forEach(animals => displayNames.push(`name: ${animals.animal_name}, scientific: ${animals.scientific_name}`))
    return displayNames
  }
  ...
  */
  ...
  function lowerCaseNames(animals){
    const lcAnimals = animals.map(value => value.animal_name.toLowerCase())
    return lcAnimals
  }
  ...
  */
  ...
  function lowPopulationAnimals(animals){
    const lowPop = animals.filter(value => value.population < 5)
    return lowPop
  }
  ...
  */
  ...
  function USApop(animals){
    const wholePop = animals.reduce((acc, current) => {
      let total = acc + current.population
      return total
      }, 0)
    return wholePop
  }
